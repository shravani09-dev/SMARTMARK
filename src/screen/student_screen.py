...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_btn(current_sid: str = sid) -> None:
...
def student_screen():
    ...
    if show_registration:
        with st.container(border = True):
            ...
            new_name = st.text_input("Enter your name", placeholder = "E.g. Shravanib Dhenge")
                    ...
                    with st.spinner("Creating profile.."):
                        ...
                        if encodings:
                            ...
                            if response_data:
                                ...
                                st.error("Coundn't capture your facial features for registration")
